        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <ul>
              ...
              <li>שימוש בלפחות 3 סוגי מתכונים (לדוגמה: מתכון בשרי, מתכון קינוח ומתכון בסגנון איטלקי)</li>
            </ul>
            <h5>סו שף</h5>
            <ul>
              <li>לפרסם לפחות 10 מתכונים</li>
              <li>שימוש בלפחות 5 סוגי מתכונים</li>
            </ul>
            <h5>שף</h5>
            <ul>
              <li>לפרסם לפחות 12 מתכונים</li>
              <li>שימוש בלפחות 6 סוגי מתכונים</li>
